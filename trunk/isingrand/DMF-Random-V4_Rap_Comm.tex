...
$h_{i}$ are, respectively, the (quenched) interactions and on-site fields\textemdash both drawn randomly 
...
{(a)} Exponential relaxation of the expectation value of ${m^{z}}$ with time for different
...
{(b)} {\it $\tau$ vs $\omega$ for fixed $h_{0}$}: 
